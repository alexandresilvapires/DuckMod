...
public class DuckEggItem extends Item implements ProjectileItem {
    ...
    public InteractionResult use(Level level, Player player, InteractionHand interactionHand) {
        ...
        if (level instanceof ServerLevel serverLevel) {
            Projectile.spawnProjectileFromRotation(DuckThrownEgg::new, serverLevel, itemStack, player, 0.0F, 1.5F, 1.0F);
        }
    ...
    public Projectile asProjectile(Level level, Position position, ItemStack itemStack, Direction direction) {
        return new DuckThrownEgg(level, position.x(), position.y(), position.z(), itemStack);
    }
}