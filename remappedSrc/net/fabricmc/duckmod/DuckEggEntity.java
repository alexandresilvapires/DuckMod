...
public class DuckEggEntity extends ThrownItemEntity {
    ...
    public void handleStatus(byte status) {
        if (status == 3) {
            ...
            for (int i = 0; i < 8; ++i) {
                this.method_48926().addParticle(new ItemStackParticleEffect(ParticleTypes.ITEM, this.getStack()), this.getX(),
